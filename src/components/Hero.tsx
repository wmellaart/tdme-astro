...
<img src={logo.src as string} alt="tdme" className="h-14" />
...
<img src={londonImg.src as string} alt="London skyline" className="absolute inset-0 w-full h-full object-cover" />
